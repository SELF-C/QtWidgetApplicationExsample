...
GLuint ShaderProgram::addShaderFromSourceFile(const QString vertexFileName, const QString fragmentFileName)
{
...
int ShaderProgram::readShaderSource(GLuint shaderObj, const QString fileName)
{
    QFile f(fileName);
...
int ShaderProgram::compileSourceCode(GLuint shader)
{
    GLint compiled;
